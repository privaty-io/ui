...
<!-- Below the playground's floating header pill — a real app would own
     the full viewport. -->
<div class="fixed inset-x-0 top-16 bottom-0">
  <TileCanvas class="flex h-full flex-col">
              ...
              <div class="mx-auto flex max-w-xl flex-col gap-4">
                <div>
                  ...
                  <p class="text-sm text-stone-500">
                    Tab through the page — the pane you're in stays marked. Grab
                    a gutter to resize; drag the nav hard left to collapse it;
