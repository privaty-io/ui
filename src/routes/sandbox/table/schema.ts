...
// The row id travels IN the data (the Table renders it as a hidden input in
// the editor row) — `.for(key)` only routes the client instance; the server
// handler never receives the key itself.
